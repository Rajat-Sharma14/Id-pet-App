...
router.post('/addUserByAdmin',adminContoller.addUserByAdmin)
router.post('/getUserById',adminContoller.getUserById)
router.post('/editUserAdmin',  adminContoller.editUserByAdmin)
